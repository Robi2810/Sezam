        ...
        <div className="detailed-card">
            <table>
                <tr>
                    ...
                    <td colSpan={2} className="detailed-card-title">{kb.name}</td>
                </tr>
                <tr>
                    <td colSpan={2} className="detailed-description">{kb.description}
                    </td>
                </tr>
                {kb.type === KnowledgeBaseTypeEnum.CREDENTIALS ? <tr>
                ...
                <td width="49%" rowSpan={4}>
                    <table className="warning-block">
                        <tr>
                            ...
                            <td width="10px"/>
                            <td>
                                <div className="info-text">Для вас доступна сессия до {new Date(detailedInfo.endAt).toLocaleString()}, после завершения работы с
...
function hseLogin(redirectUrl: string) {
    return <div>
        <div className="info-title">Метод Аутентификации</div>
        <div className="info-text">Для авторизации/регистрации в <a href={redirectUrl}
    ...
    return <div className="file-list">
        ...
        <table className="element">
            ...
            <><tr>
                    ...
                    <td width="0"><a href={f.url} download={true}><img className="download" src={download}/></a></td>
                </tr><tr>
                        <td colSpan={3}>
